...
<div class="result-container">   
    ...
    <!-- Titulo principal do jogo (pode ser o mesmo nome de antes, como "Quiz das Capitais")-->
    ...
    <div>
        <a href="index.php?route-start" class="btn btn-secondary 9-3 w-50">Jogar novamente</a>
    </div>
</div>
